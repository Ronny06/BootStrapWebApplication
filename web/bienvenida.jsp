<%-- 
    Document   : bienvenida
    Created on : 27/11/2019, 04:45:13 PM
    Author     : cpcastillo
--%>
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-md navbar-dark bg-dark flex-row">
            <a class="navbar-brand mr-auto" href="/">
                <img src="imagenes/idatLogo_1.jpg" class="img-fluid" alt="Responsive image">
            </a>
        ...
        <nav class="navbar navbar-expand-md navbar-light">
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="modulo1.jsp" >Modulo1</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">Modulo2</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">Modulo3</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">Modulo4</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">Modulo5</a>
                    </li>
                </ul>
        ...
        <section id="seccion1">
            <div>
                <table id="ejemplo1" class="display" style="width: 100%">
                    <thead>
                        <tr>
                            <th>Nombre</th>
                            <th>Posicion</th>
        ...
        <footer class="mt-auto fixed-bottom p-3">
            ...
            <small>Copyright &copy; www.idat.edu.pe</small>
